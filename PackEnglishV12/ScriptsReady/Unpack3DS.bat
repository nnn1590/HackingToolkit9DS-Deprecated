...
"%PROGRAMFILES%\HackingToolkit9DS\3dstool.exe" -xvt01267f cci %1_Unpacked/DecryptedPartition0.bin %1_Unpacked/DecryptedPartition1.bin %1_Unpacked/DecryptedPartition2.bin %1_Unpacked/DecryptedPartition6.bin %1_Unpacked/DecryptedPartition7.bin %1 --header %1_Unpacked/HeaderNCSD.bin > /dev/null 2>&1
